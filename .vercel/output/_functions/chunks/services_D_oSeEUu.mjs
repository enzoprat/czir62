const services = [
  {
    ...
    metaDescription: "Pose et remplacement de tuiles, ardoises, faîtage et écran sous-toiture à Béthune. Entreprise de couverture avec un local en ville. Devis gratuit.",
    cardText: "Pose, remplacement et entretien de la couverture : tuiles mécaniques, ardoises, faîtage, écran sous-toiture.",
    intent: "prestation",
  ...
  },
  {
    ...
    metaDescription: "Rénovation complète ou partielle de toiture à Béthune : dépose, écran sous-toiture, couverture neuve, zinguerie. Évaluation de toiture sur place.",
    cardText: "Reprise complète ou partielle : dépose de l'ancienne couverture, écran sous-toiture, couverture neuve, zinguerie associée.",
    intent: "projet",
  ...
  },
  {
    ...
    metaDescription: "Tuiles cassées, faîtage descellé, solin fissuré : réparation ciblée de toiture à Béthune et alentours. Diagnostic sur place avant travaux.",
    cardText: "Intervention ciblée sur un désordre localisé : tuiles déplacées, faîtage descellé, solin fissuré, rive abîmée.",
    intent: "urgence",
  ...
  },
  {
    ...
    metaDescription: "Auréole au plafond, infiltration après la pluie ? Recherche de fuite et réparation d'étanchéité à Béthune. Décrivez la situation, on vous rappelle.",
    cardText: "Recherche du point d'entrée réel de l'eau puis réparation : raccords, solins, noues, faîtage, abords de Velux.",
    intent: "urgence",
  ...
  },
  {
    ...
    metaDescription: "Démoussage de toiture à Béthune : retrait mécanique des mousses, contrôle de la couverture et des gouttières. Ce qu'il règle — et ce qu'il ne règle pas.",
    cardText: "Retrait des mousses et des lichens sur une couverture encore saine, contrôle des points faibles pendant l'intervention.",
    intent: "prestation",
    targetQueries: [
  ...
  },
  {
    ...
    metaDescription: "Gouttières, chéneaux, noues, solins et habillages en zinc à Béthune. Remplacement d'éléments corrodés et reprise des raccords d'étanchéité.",
    cardText: "Gouttières, descentes, chéneaux, noues, solins et habillages : tout ce qui conduit l'eau hors de la toiture.",
    intent: "prestation",
  ...
  },
  {
    ...
    metaDescription: "Charpente traditionnelle et fermettes à Béthune : reprise de pièces fragilisées, renforcement, modification pour aménagement de combles.",
    cardText: "Structure porteuse : reprise de pièces fragilisées, renforcement, modification dans le cadre d'un projet.",
    intent: "prestation",
  ...
  },
  {
    ...
    metaDescription: "Installation, remplacement et réparation de fenêtres de toit à Béthune. Raccord d'étanchéité, adaptation de la charpente, finitions intérieures.",
    cardText: "Création d'ouverture, remplacement d'un modèle ancien, reprise d'un raccord d'étanchéité qui laisse passer l'eau.",
    intent: "produit",
  ...
  },
  {
    ...
    metaDescription: "Pose de bardage bois, composite ou métallique à Béthune : habillage de pignon, protection de façade, finition d'agrandissement.",
    cardText: "Habillage de pignon ou de façade : ossature, lame d'air ventilée, pose du parement et traitement des points singuliers.",
    intent: "projet",
  ...
  },
  {
    ...
    metaDescription: "Ossature bois à Béthune : extension, annexe, garage, abri. Montage de la structure, contreventement, mise hors d'eau et hors d'air.",
    cardText: "Structure murale porteuse en bois pour une extension, une annexe ou un garage : montage, contreventement, mise hors d'eau.",
    intent: "construction",
  ...
  },
  {
    ...
    metaDescription: "Extension, surélévation, réhaussement de toiture à Béthune : étude de faisabilité, structure, raccordement à l'existant et mise hors d'eau.",
    cardText: "Gagner de la surface : extension de plain-pied, surélévation, ou réhaussement pour rendre des combles habitables.",
    intent: "construction",
  ...
  },
  {
    ...
    metaDescription: "Étanchéité de toiture-terrasse à Béthune : membrane bitume, EPDM, relevés d'acrotère, évacuations. Reprise ponctuelle ou réfection complète du complexe.",
    cardText: "Toit plat, garage, extension : membrane, relevés d'acrotère, évacuations. Sans pente, tout repose sur l'étanchéité.",
    intent: "prestation",
  ...
  },
  {
    ...
    metaDescription: "Bac acier, joint debout et zinc à Béthune : faibles pentes, annexes, bâtiments professionnels. Condensation et dilatation traitées dès la conception.",
    cardText: "Bac acier ou joint debout : la solution des faibles pentes, des grandes portées et des volumes contemporains.",
    intent: "prestation",
...
const servicesByOrder = [...services].sort((a, b) => a.order - b.order);
...
function getRelated(slug, limit = 4) {
  return getService(slug).related.slice(0, limit).map(getService);
}
...
function servicesOfFamily(family) {
...
export { services as a, subServices as b, serviceFamilies as c, servicesOfFamily as d, getRelated as e, getService as g, servicesByOrder as s };
